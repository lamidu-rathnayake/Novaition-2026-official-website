...
export default function Contact() {
    return (
        <section className="page-container py-4 w-full bg-muted text-foreground flex flex-col items-center justify-center h-auto md:h-screen">

            {/* Title */}
            <h2 className="text-5xl md:text-6xl font-bold text-center py-12 tracking-wider text-white uppercase">
                CONTACT US
            </h2>

            <div className="w-full mx-auto flex flex-col md:flex-row items-stretch justify-center gap-8 md:gap-0 relative">
                ...
                <div className="w-full md:w-1/2 flex flex-col items-center md:items-end gap-12 md:pr-0 text-center md:text-right">
